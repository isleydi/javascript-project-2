...
// poison is initialized based on the character, but otherwise has a
// size and position
function poison(pos, ch) {
  ...
  if (ch == "=") {
    ...
    // Drip poison. Repeat back to this pos.
...
var wobbleSpeed = 12, wobbleDist = 0.07;
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  // Handle poison by calling playerTouched
  if (obstacle)
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // if the player touches poison and the player hasn't won
  // Player loses
...
{
  this.player.pos = new Vector(15,10);
}
